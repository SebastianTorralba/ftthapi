        ...
        <Popover className="menuPopover" placement={'right'} isOpen={this.state.popoverOpen} target={'popover-herramienta-tipo-mapa'} toggle={this.toggle}>
          ...
          <PopoverBody>
            <ul className="list-group list-group-flush">
              ...
              <li key="mapa-style-black" name="mapa-style-black" onClick={() => {this.props.handleMapaStyle(styles.comun); this.props.handleMapaTypeId("roadmap");}} className="list-group-item">Mapa Común</li>              
              <li key="mapa-style-satellite" name="mapa-type-satellite" onClick={() => {this.props.handleMapaTypeId("satellite");}} className="list-group-item">Mapa satelital</li>
            </ul>
          </PopoverBody>
        </Popover>
      </span>
