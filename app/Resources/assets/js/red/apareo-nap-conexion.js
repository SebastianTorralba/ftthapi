...
import {Window} from './apareo-nap-conexion/window';
import {Filtro} from './apareo-nap-conexion/filtro';
import opciones from './apareo-nap-conexion/window/menu/opciones.json'
...
class App extends React.Component {
  ...
  state = {
    ...
    "mapZoom": 14,
    "dimensionMarker": 16,
    "defaultCenter": {lat:-28.0631595,lng:-67.5809792},
